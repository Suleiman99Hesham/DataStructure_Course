...
template <class T> void listTraversal(Linkedlist<T> l) {
...
template <class T> void reversedlistTraversal(Linkedlist<T> l) {
    typename Linkedlist<T>::iterator it = l.end();
    while (it != l.begin()) {
        --it;
        cout << *it << ' ';
    }
